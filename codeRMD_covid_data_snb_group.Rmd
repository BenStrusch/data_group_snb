---
title: "Data Group SNB Covid - Did Stringency Measures Affect Happiness across the world between 2020 and 2022?"
...
# remove NAs from Dataset for countries without a happiness score and remove 2019 as it is no longer needed

# create new data frames to keep "raw" data
...
# test relationship between Stringency and Happiness + create plots
...
## test happiness vs. death differences and create plots
...
## test happiness vs. stringency and deathsdiff, create plots
...
## plot cases vs. happiness (by deaths) and test it
...
# create subsets per year, then run regression of Stringency on Happiness per year
