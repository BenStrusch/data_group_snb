...
avg_pre_pandemic <- allStr_h2019 %>%
  ...
  select(-c(Happy2015, Happy2016, Happy2017, Happy2018, Happy2019, total_pre_pandemic_happiness))
...
Happy_Country_Year_all <- allStr_allHap %>%
  ...
  rename("avg_pre_pandemic_happiness" = avg_pre_pandemic_happiness, "2020" = Happy2020, "2021" = Happy2021, "2022" = Happy2022, "Region" = Regional.indicator) %>%
  select(country_name, country_code, "avg_pre_pandemic_happiness", "2020", "2021", "2022", "Region") 

Happy_Country_Year_all <- Happy_Country_Year_all %>%
  pivot_longer(c("avg_pre_pandemic_happiness", "2020", "2021", "2022"), names_to = "year", values_to = "Happiness")

Happy_Country_Year_total <- allStr_allHap %>%
  mutate(Happy2020=Happy2020-avg_pre_pandemic_happiness) %>%
  mutate(Happy2021=Happy2021-avg_pre_pandemic_happiness) %>%
  mutate(Happy2022=Happy2022-avg_pre_pandemic_happiness) %>%
  mutate(avg_pre_pandemic_happiness=avg_pre_pandemic_happiness-avg_pre_pandemic_happiness) %>%
...
Happy_Country_Year_total <- Happy_Country_Year_total %>%
  pivot_longer(c("avg_pre_pandemic_happiness", "2020", "2021", "2022"), names_to = "year", values_to = "Happiness")
...
total_data<- total_data %>% filter (year != "avg_pre_pandemic_happiness")
