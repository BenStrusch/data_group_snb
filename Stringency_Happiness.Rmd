...
# 1 - read stringency and happiness data
...
# 2 Wrangling Stringency data

filter for total countries and get rid of states
```{r}
...
create subsets to calculate average stringency 
```{r}
Ox2020 <- OxCGRT %>%
...
combine average stringency to one df incl country_code
```{r}
...
rename and add "0" for stringency in 2019 before COVID
```{r}
...
transpose to prepare visualization
```{r}
...
# 3 Combine happiness with stringency
```{r}
#Str all + 2019
